...
routes.get(
  "/jobopportunity/:idJobOpportunity",
  jobopportunity.getJobOpportunityById
);
routes.get("/jobopportunity/user/:idUser", jobopportunity.listByUser);
routes.get(
  "/jobopportunity/report/:idJobOpportunity",
  jobopportunity.getInterviewsByJobOpportunity
);
...
routes.post(
  "/jobopportunity_skill/:idJobOpportunity",
  jobopportunity_skill.create
);
routes.delete(
  "/jobopportunity_skill/:idJobOpportunity_Skill",
  jobopportunity_skill.delete
);
routes.put(
  "/jobopportunity_skill/:idJobOpportunity_Skill",
  jobopportunity_skill.update
);
routes.get(
  "/jobopportunity_skill/:idJobOpportunity",
  jobopportunity_skill.findByIdofJobOpportunitySkill
);
routes.get("/jobopportunity_skill", jobopportunity_skill.getTop10);
routes.get(
  "/jobopportunity_skill/softvsHard",
  jobopportunity_skill.getSoftVSHard
);
